...
library(reticulate)
reticulate::use_condaenv("python38", required = TRUE)
reticulate::conda_install("python38", c("libtiff", "Pillow", "matplotlib"))
reticulate::py_install(c("scikit-learn", "seaborn"))
