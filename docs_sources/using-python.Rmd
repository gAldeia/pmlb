...
```{r, include=FALSE}
library(reticulate)
reticulate::use_condaenv("pmlb_env", required = TRUE)
reticulate::conda_install("pmlb_env", c("PyQt5", "matplotlib", "scikit-learn", "seaborn"))
...
sns.boxplot(data=[logit_test_scores, gnb_test_scores], notch=True)
